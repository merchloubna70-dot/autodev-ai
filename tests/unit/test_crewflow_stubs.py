...
def test_issue_pipeline_crewflow_constructs():
    ...
    from autodev.flows.issue_pipeline_crewflow import IssuePipelineCrewFlow
...
def test_issue_pipeline_crewflow_run_raises_when_crewai_unavailable(monkeypatch):
    ...
    import autodev.flows.issue_pipeline_crewflow as mod

    monkeypatch.setattr(mod, "_CREWAI_AVAILABLE", False)

    from autodev.flows.issue_pipeline_crewflow import (
        IssuePipelineCrewFlow,
...
def test_project_delivery_crewflow_constructs():
    ...
    from autodev.flows.project_delivery_crewflow import ProjectDeliveryCrewFlow
...
def test_project_delivery_crewflow_run_raises_when_crewai_unavailable(monkeypatch):
    """When crewai is unavailable, .run() raises RuntimeError with correct message."""
    import autodev.flows.project_delivery_crewflow as mod

    monkeypatch.setattr(mod, "_CREWAI_AVAILABLE", False)

    from autodev.flows.project_delivery_crewflow import (
        ProjectDeliveryCrewFlow,
...
def test_crewai_availability_flag_consistency():
    ...
    import autodev.flows.issue_pipeline_crewflow as issue_mod
    import autodev.flows.project_delivery_crewflow as delivery_mod
